...
if !exists("g:ctags_command")
  if has("vms")
    ...
    let g:ctags_command = "/usr/bin/find . -type f \|/usr/bin/xargs ctags"
  endif
endif
...
if exists("*Do_toolbar_tmenu")
  ...
  tmenu ToolBar.RunCtags	Build tags in current directory tree (!/usr/bin/find . -type f \|/usr/bin/xargs ctags)
